...
Each post defines a set of metadata using frontmatter format. There are a few properties that are generated by default by **Nextein**: `slug`, `category`, `page` and `date`. You can override any property using the frontmatter section.
